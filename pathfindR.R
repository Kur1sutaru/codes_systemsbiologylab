...
setwd("C:/Users/crist/Downloads/AICARDI GOUTIERRES SYNDROME NETWORK ANALYSIS/GEO/GSE193711")
...
write.csv(pathwaysresults, "agsxwt.csv")
enrichment_chart(pathwaysresults, top_terms = 20)
term_gene_graph(pathwaysresults, num_terms = 3,use_description = TRUE)
term_gene_heatmap(pathwaysresults, gse193711, num_terms = 10, use_description = TRUE)
